...
|---|------|------------------------|-------------|
| 1 | Trevor | Business Understanding (Problem & Solution) | Project Lead / Business Analyst |
| 2 | Ibrahim | Data Understanding & Data Preparation | Data Engineer |
| 3 | Mary | Exploratory Data Analysis (EDA) | Data Analyst |
| 4 | Godwin | Modelling (RFM & Clustering) | Machine Learning Engineer |
...
- Coordinate timelines, run weekly check-ins, and track overall project progress (Scrum-lite: stand-ups + task board).
- Own the final repo README and ensure consistency across all notebooks/reports.
- Liaise between the team and the "client" (Mr. Kaloki) for scope clarifications.
...
- Final repo README.md (project overview, setup instructions, team credits).
- Weekly progress tracker (e.g., GitHub Projects board or Trello export).
